...
> **版本：** v1.0 | **日期：** 2026-05-16 | **状态：** Draft
...
ZOAN 是一个面向 AI 转型时代的**高端人才网络与咨询平台**，为企业关键阶段连接"懂行业 + 会用 AI"的高阶独立人才。
...
ZOAN 翻译需求，输出精准 JD
         ↓
人才端：行业老兵（懂业务、打过仗）→ ZOAN 提供 AI upskilling → 达到可派出水平
         ↓
...
**人才筛选的真实标准：** 行业内纵深经验 + 多元业务知识 + 实打实的战功（能做事），然后通过 ZOAN 的课程体系补齐 AI 能力。
...
|---|------|----------|------|------|
| 1 | `/` | 首页 | 直接访问 | 双受众 |
| 2 | `/about` | 关于我们 | Header 认识ZOAN | 双受众 |
| 3 | `/why-zoan` | 为什么选择ZOAN | Header 认识ZOAN | 双受众 |
...
**目的：** 完整的品牌叙事，让用户在30秒内理解ZOAN是谁、做什么、怎么做。

| Section | 内容 | 组件 |
|---------|------|------|
| Hero | 一句话定位 + 副标题 + 双CTA按钮 | HeroSection |
| 我们是谁 | ZOAN 的定位描述（2-3句话） | TextSection |
...
|---------|------|
| Hero | "AI 时代的人才训战" |
| 课程理念 | 为什么 ZOAN 做课程（人才能力升级、不只是招募） |
...
3. 中英双语品牌名同时出现时：中文在前，英文（ZOAN）在后
